module miko::tests {
    ...
    /// Helper to advance mocked time if framework in test environment provides it.
    /// (If unavailable, claim test will still work with zero accrual; kept for clarity.)
